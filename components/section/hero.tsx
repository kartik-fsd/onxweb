...
import ContactBtn from "../ui/contactUs";

export default function Hero() {
  return (
    <section
      className="container relative h-full overflow-hidden sm:mb-14"
      aria-labelledby="hero-heading"
      id="hero"
    >
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 pb-10">
        <GridPattern
          width={20}
          height={20}
          x={-1}
          ...
          aria-hidden="true"
        />
        <RetroGrid aria-hidden="true" />
        <ExploreBtn />
        <div className="mt-5 max-w-6xl text-center mx-auto z-50">
          <h1
            id="hero-heading"
            className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-indigo-900 mb-4"
          >
            India&apos;s Leading
            <span className="py-2 block">B2B Service Marketplace</span>
          </h1>
        </div>

        <div className="mt-5 max-w-3xl text-center mx-auto">
          <p className="text-lg md:text-xl text-gray-600 mb-8">
            Streamline Your Business Operations with Expert Onboarding &
        ...
        <div className="gap-3 flex justify-center">
          <div className="group relative mt-10 inline-flex">
            <ContactBtn />
            <div
              className="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-indigo-600 md:inline-flex"
              aria-hidden="true"
            >
              <svg
                viewBox="0 0 82 35"
